    ...
    module.exports = shouldUseNative() ? Object.assign : function(target, source) {
      ...
      for (var s4 = 1; s4 < arguments.length; s4++) {
        ...
        if (getOwnPropertySymbols) {
          ...
          for (var i4 = 0; i4 < symbols2.length; i4++) {
            if (propIsEnumerable.call(from, symbols2[i4])) {
              to3[symbols2[i4]] = from[symbols2[i4]];
            }
          }
        }
      }
    ...
    (function() {
      ...
      var runInContext = function runInContext2(context) {
        ...
        function reorder(array2, indexes2) {
          var arrLength = array2.length, length = nativeMin(indexes2.length, arrLength), oldArray = copyArray(array2);
          while (length--) {
            var index2 = indexes2[length];
        ...
        var pullAt = flatRest(function(array2, indexes2) {
          var length = array2 == null ? 0 : array2.length, result2 = baseAt(array2, indexes2);
          basePullAt(array2, arrayMap(indexes2, function(index2) {
        ...
        function slice3(array2, start2, end) {
          var length = array2 == null ? 0 : array2.length;
          if (!length) {
            return [];
          }
        ...
        function unzip(array2) {
          ...
          var length = 0;
          array2 = arrayFilter(array2, function(group2) {
        ...
        function repeat(string, n4, guard) {
          ...
          return baseRepeat(toString(string), n4);
        }
        function replace() {
        ...
        var attempt = baseRest(function(func, args) {
          try {
            ...
            return isError(e7) ? e7 : new Error2(e7);
          }
        });
...
function useTransition(data, props, deps) {
  ...
  each(transitions, (t7, i4) => {
    ...
    payload.onResolve = (result) => {
      ...
      const t23 = transitions2.find((t33) => t33.key === key);
      if (!t23)
        return;
      ...
      if (t23.ctrl.idle) {
        const idle = transitions2.every((t33) => t33.ctrl.idle);
        if (t23.phase == "leave") {
        ...
        if (idle && transitions2.some((t33) => t33.expired)) {
...
var b = (0, import_react15.memo)(function(t7) {
  var o4, n4 = t7.position, r4 = t7.anchor, e7 = t7.children, l3 = Ut(), u3 = $r(), p4 = u3.animate, f3 = u3.config, b4 = Lt(), g3 = b4[0], w4 = b4[1], T4 = (0, import_react15.useRef)(false), C7 = void 0, E5 = false, P4 = w4.width > 0 && w4.height > 0, j4 = Math.round(n4[0]), N4 = Math.round(n4[1]);
  P4 && ("top" === r4 ? (j4 -= w4.width / 2, N4 -= w4.height + 14) : "right" === r4 ? (j4 += 14, N4 -= w4.height / 2) : "bottom" === r4 ? (j4 -= w4.width / 2, N4 += 14) : "left" === r4 ? (j4 -= w4.width + 14, N4 -= w4.height / 2) : "center" === r4 && (j4 -= w4.width / 2, N4 -= w4.height / 2), C7 = { transform: m(j4, N4) }, T4.current || (E5 = true), T4.current = [j4, N4]);
  var O3 = useSpring({ to: C7, config: f3, immediate: !p4 || E5 }), V3 = v({}, x, l3.tooltip, { transform: null != (o4 = O3.transform) ? o4 : m(j4, N4) });
...
var w = (0, import_react15.memo)(function(t7) {
  var i4, o4 = t7.id, n4 = t7.value, r4 = t7.format, e7 = t7.enableChip, l3 = void 0 !== e7 && e7, a5 = t7.color, c9 = t7.renderContent, h3 = Ut(), d3 = Yt(r4);
...
var C = (0, import_react15.memo)(function(t7) {
  var i4, o4 = t7.title, n4 = t7.rows, r4 = void 0 === n4 ? [] : n4, e7 = t7.renderContent, l3 = Ut();
...
var E = (0, import_react15.memo)(function(t7) {
  var i4 = t7.x0, n4 = t7.x1, r4 = t7.y0, e7 = t7.y1, l3 = Ut(), d3 = $r(), u3 = d3.animate, p4 = d3.config, f3 = (0, import_react15.useMemo)(function() {
...
var V = function(t7) {
  var i4 = (0, import_react15.useState)(N), n4 = i4[0], l3 = i4[1], a5 = (0, import_react15.useCallback)(function(t8, i5, o4) {
    ...
    void 0 === n5 && (n5 = "top");
    var r4 = t7.current.getBoundingClientRect(), e7 = t7.current.offsetWidth, a6 = e7 === r4.width ? 1 : e7 / r4.width, c10 = (o4.clientX - r4.left) * a6, s5 = (o4.clientY - r4.top) * a6;
...
define_default(Cubehelix, cubehelix, extend(Color, {
  ...
  rgb: function() {
    var h3 = isNaN(this.h) ? 0 : (this.h + 120) * radians, l3 = +this.l, a5 = isNaN(this.s) ? 0 : this.s * l3 * (1 - l3), cosh2 = Math.cos(h3), sinh2 = Math.sin(h3);
    return new Rgb(
...
function basis(t14, v0, v1, v22, v32) {
  ...
  return ((1 - 3 * t14 + 3 * t23 - t33) * v0 + (4 - 6 * t23 + 3 * t33) * v1 + (1 + 3 * t14 + 3 * t23 - 3 * t33) * v22 + t33 * v32) / 6;
}
...
var rgb_default = function rgbGamma(y4) {
  ...
  function rgb4(start2, end) {
    var r4 = color3((start2 = rgb2(start2)).r, (end = rgb2(end)).r), g3 = color3(start2.g, end.g), b4 = color3(start2.b, end.b), opacity = nogamma(start2.opacity, end.opacity);
    return function(t7) {
      start2.r = r4(t7);
      start2.g = g3(t7);
      start2.b = b4(t7);
...
function rgbSpline(spline) {
  return function(colors3) {
    var n4 = colors3.length, r4 = new Array(n4), g3 = new Array(n4), b4 = new Array(n4), i4, color3;
    for (i4 = 0; i4 < n4; ++i4) {
      color3 = rgb2(colors3[i4]);
      r4[i4] = color3.r || 0;
      g3[i4] = color3.g || 0;
      b4[i4] = color3.b || 0;
    }
...
function decompose_default(a5, b4, c9, d3, e7, f3) {
...
function bisector_default(f3) {
  ...
  function center(a5, x6, lo, hi) {
    if (lo == null)
      lo = 0;
    if (hi == null)
      hi = a5.length;
    const i4 = left(a5, x6, lo, hi - 1);
...
function formatLocale(locale4) {
  ...
  function newFormat(specifier, formats2) {
    return function(date) {
      var string = [], i4 = -1, j4 = 0, n4 = specifier.length, c9, pad2, format3;
      ...
      while (++i4 < n4) {
        if (specifier.charCodeAt(i4) === 37) {
          ...
          if ((pad2 = pads[c9 = specifier.charAt(++i4)]) != null)
            ...
            pad2 = c9 === "e" ? " " : "0";
          if (format3 = formats2[c9])
            c9 = format3(date, pad2);
          string.push(c9);
          j4 = i4 + 1;
        }
      }
...
function sinebow_default(t7) {
  var x6;
  t7 = (0.5 - t7) * Math.PI;
  c6.r = 255 * (x6 = Math.sin(t7)) * x6;
  c6.g = 255 * (x6 = Math.sin(t7 + pi_1_3)) * x6;
  c6.b = 255 * (x6 = Math.sin(t7 + pi_2_3)) * x6;
  return c6 + "";
}
...
function line_default() {
  var x6 = x2, y4 = y2, defined = constant_default3(true), context = null, curve = linear_default, output = null;
  function line(data) {
  ...
  line.x = function(_2) {
    return arguments.length ? (x6 = typeof _2 === "function" ? _2 : constant_default3(+_2), line) : x6;
  };
  line.y = function(_2) {
...
MonotoneX.prototype = {
  ...
  point: function(x6, y4) {
    ...
    switch (this._point) {
      ...
      case 2:
        this._point = 3;
        point5(this, slope2(this, t14 = slope3(this, x6, y4)), t14);
        break;
      default:
        point5(this, this._t0, t14 = slope3(this, x6, y4));
        break;
    }
    this._x0 = this._x1, this._x1 = x6;
    this._y0 = this._y1, this._y1 = y4;
...
function wiggle_default(series, order) {
  ...
  for (var y4 = 0, j4 = 1, s0, m4, n4; j4 < m4; ++j4) {
    for (var i4 = 0, s1 = 0, s22 = 0; i4 < n4; ++i4) {
      var si2 = series[order[i4]], sij0 = si2[j4][1] || 0, sij1 = si2[j4 - 1][1] || 0, s32 = (sij0 - sij1) / 2;
...
function formatDecimalParts2(x6, p4) {
  if ((i4 = (x6 = p4 ? x6.toExponential(p4 - 1) : x6.toExponential()).indexOf("e")) < 0)
    return null;
  var i4, coefficient = x6.slice(0, i4);
  return [
...
var prefixExponent2;
function formatPrefixAuto_default2(x6, p4) {
  var d3 = formatDecimalParts2(x6, p4);
  if (!d3)
    return x6 + "";
  ...
  return i4 === n4 ? coefficient : i4 > n4 ? coefficient + new Array(i4 - n4 + 1).join("0") : i4 > 0 ? coefficient.slice(0, i4) + "." + coefficient.slice(i4) : "0." + new Array(1 - i4).join("0") + formatDecimalParts2(x6, Math.max(0, p4 + i4 - 1))[0];
}

// node_modules/d3-format/src/formatRounded.js
function formatRounded_default2(x6, p4) {
  var d3 = formatDecimalParts2(x6, p4);
  if (!d3)
    return x6 + "";
  var coefficient = d3[0], exponent = d3[1];
...
var formatTypes_default2 = {
  ...
  "p": function(x6, p4) {
    return formatRounded_default2(x6 * 100, p4);
  },
...
function Mr() {
  return Mr = Object.assign ? Object.assign.bind() : function(e7) {
...
var Nr = function(e7, r4) {
  var t7 = (0, import_merge2.default)({}, e7, r4);
  return Kr.forEach(function(e8) {
    void 0 === (0, import_get.default)(t7, e8 + ".fontFamily") && (0, import_set2.default)(t7, e8 + ".fontFamily", t7.fontFamily), void 0 === (0, import_get.default)(t7, e8 + ".fontSize") && (0, import_set2.default)(t7, e8 + ".fontSize", t7.fontSize), void 0 === (0, import_get.default)(t7, e8 + ".fill") && (0, import_set2.default)(t7, e8 + ".fill", t7.textColor);
  }), t7;
};
var Vr = (0, import_react16.createContext)();
var Jr = function(e7) {
  var t7 = e7.children, i4 = e7.animate, n4 = e7.config, o4 = (0, import_react16.useMemo)(function() {
    var e8 = (0, import_lodash.isString)(n4) ? config[n4] : n4;
    return { animate: i4, config: e8 };
  }, [i4, n4]);
  return (0, import_jsx_runtime2.jsx)(Vr.Provider, { value: o4, children: t7 });
};
...
Jr.defaultProps = Zr;
var $r = function() {
  return (0, import_react16.useContext)(Vr);
};
...
var Dt = function(e7) {
  return "function" == typeof e7 ? e7 : "string" == typeof e7 ? 0 === e7.indexOf("time:") ? timeFormat(e7.slice("5")) : format2(e7) : function(e8) {
    return "" + e8;
  };
};
var Yt = function(e7) {
...
var At = (0, import_react16.createContext)();
var Ft = {};
var Et = function(e7) {
  var r4 = e7.theme, t7 = void 0 === r4 ? Ft : r4, i4 = e7.children, n4 = It(t7);
  return (0, import_jsx_runtime2.jsx)(At.Provider, { value: n4, children: i4 });
};
Et.propTypes = { children: import_prop_types.default.node.isRequired, theme: import_prop_types.default.object };
var Ut = function() {
  return (0, import_react16.useContext)(At);
};
var Xt = function(e7) {
...
var Kt = function(e7) {
  ...
  return (0, import_jsx_runtime2.jsx)(Et, { theme: t7, children: (0, import_jsx_runtime2.jsx)(Jr, { animate: s4, config: d3, children: (0, import_jsx_runtime2.jsx)(M, { container: u3, children: (0, import_jsx_runtime2.jsxs)(Xt, { condition: o4, wrapper: (0, import_jsx_runtime2.jsx)("div", { style: Ht, ref: u3 }), children: [r4, l3 && (0, import_jsx_runtime2.jsx)(F, {})] }) }) }) });
};
...
var Jt = function(e7) {
  var t7 = e7.children, n4 = e7.theme, o4 = e7.isInteractive, a5 = void 0 === o4 || o4, s4 = e7.renderWrapper, d3 = void 0 === s4 || s4, u3 = e7.animate, c9 = e7.motionConfig, f3 = (0, import_react16.useRef)(null), m4 = V(f3), y4 = m4.actions, v5 = m4.state, R = (0, import_react16.useCallback)(function(e8, r4) {
    return y4.showTooltipFromEvent(e8, r4);
  }, [y4.showTooltipFromEvent]), q3 = (0, import_react16.useMemo)(function() {
    return { showTooltip: a5 ? R : Nt, hideTooltip: a5 ? y4.hideTooltip : Nt };
  }, [y4.hideTooltip, a5, R]);
  return (0, import_jsx_runtime2.jsx)(Et, { theme: n4, children: (0, import_jsx_runtime2.jsx)(Jr, { animate: u3, config: c9, children: (0, import_jsx_runtime2.jsx)(j.Provider, { value: y4, children: (0, import_jsx_runtime2.jsx)(O.Provider, { value: v5, children: (0, import_jsx_runtime2.jsxs)(Xt, { condition: d3, wrapper: (0, import_jsx_runtime2.jsx)("div", { style: Vt, ref: f3 }), children: [t7(q3), a5 && (0, import_jsx_runtime2.jsx)(F, {})] }) }) }) }) });
};
...
var Qt = function(e7) {
  var r4 = e7.children, t7 = Lt(), i4 = t7[0], n4 = t7[1], o4 = n4.width > 0 && n4.height > 0;
...
var Zt = ["id", "colors"];
var $t = function(e7) {
  var r4 = e7.id, t7 = e7.colors, i4 = Br(e7, Zt);
  return (0, import_jsx_runtime2.jsx)("linearGradient", Mr({ id: r4, x1: 0, x2: 0, y1: 0, y2: 1 }, i4, { children: t7.map(function(e8) {
...
var ti = (0, import_react16.memo)(function(e7) {
...
var gi = (0, import_react16.memo)(function(e7) {
  ...
  var d3, u3 = s4, c9 = s4;
  return 0 === l3 ? d3 = "\n                M 0 0 L " + u3 + " 0\n                M 0 " + c9 + " L " + u3 + " " + c9 + "\n            " : 90 === l3 ? d3 = "\n                M 0 0 L 0 " + c9 + "\n                M " + u3 + " 0 L " + u3 + " " + c9 + "\n            " : (u3 = Math.abs(s4 / Math.sin(oi(l3))), c9 = s4 / Math.sin(oi(90 - l3)), d3 = l3 > 0 ? "\n                    M 0 " + -c9 + " L " + 2 * u3 + " " + c9 + "\n                    M " + -u3 + " " + -c9 + " L " + u3 + " " + c9 + "\n                    M " + -u3 + " 0 L " + u3 + " " + 2 * c9 + "\n                " : "\n                    M " + -u3 + " " + c9 + " L " + u3 + " " + -c9 + "\n                    M " + -u3 + " " + 2 * c9 + " L " + 2 * u3 + " " + -c9 + "\n                    M 0 " + 2 * c9 + " L " + 2 * u3 + " 0\n                "), (0, import_jsx_runtime2.jsxs)("pattern", { id: r4, width: u3, height: c9, patternUnits: "userSpaceOnUse", children: [(0, import_jsx_runtime2.jsx)("rect", { width: u3, height: c9, fill: n4, stroke: "rgba(255, 0, 0, 0.1)", strokeWidth: 0 }), (0, import_jsx_runtime2.jsx)("path", { d: d3, strokeWidth: a5, stroke: o4, strokeLinecap: "square" })] });
});
...
var mi = (0, import_react16.memo)(function(e7) {
...
var ki = function(e7) {
  ...
  return !r4 || r4.length < 1 ? null : (0, import_jsx_runtime2.jsx)("defs", { "aria-hidden": true, children: r4.map(function(e8) {
    var r5 = e8.type, t7 = Br(e8, Ri);
    return qi[r5] ? (0, import_react16.createElement)(qi[r5], Mr({ key: t7.id }, t7)) : null;
  }) });
};
...
var Oi = (0, import_react16.memo)(xi);
var Wi = function(e7) {
  var r4 = e7.x, t7 = e7.y, i4 = e7.symbol, n4 = void 0 === i4 ? Oi : i4, o4 = e7.size, a5 = e7.datum, l3 = e7.color, s4 = e7.borderWidth, u3 = e7.borderColor, c9 = e7.label, f3 = e7.labelTextAnchor, p4 = void 0 === f3 ? "middle" : f3, h3 = e7.labelYOffset, g3 = void 0 === h3 ? -12 : h3, b4 = Ut(), m4 = $r(), y4 = m4.animate, v5 = m4.config, R = useSpring({ transform: "translate(" + r4 + ", " + t7 + ")", config: v5, immediate: !y4 });
  return (0, import_jsx_runtime2.jsxs)(animated.g, { transform: R.transform, style: { pointerEvents: "none" }, children: [(0, import_react16.createElement)(n4, { size: o4, color: l3, datum: a5, borderWidth: s4, borderColor: u3 }), c9 && (0, import_jsx_runtime2.jsx)("text", { textAnchor: p4, y: g3, style: b4.dots.text, children: c9 })] });
};
...
var Ci = (0, import_react16.memo)(Wi);
var zi = function(e7) {
  var r4 = e7.width, t7 = e7.height, i4 = e7.axis, n4 = e7.scale, o4 = e7.value, a5 = e7.lineStyle, l3 = e7.textStyle, s4 = e7.legend, d3 = e7.legendPosition, u3 = e7.legendOffsetX, c9 = e7.legendOffsetY, f3 = e7.legendOrientation, p4 = Ut(), h3 = 0, g3 = 0, b4 = 0, m4 = 0;
  "y" === i4 ? (b4 = n4(o4), g3 = r4) : (h3 = n4(o4), m4 = t7);
  var y4 = null;
  if (s4) {
    var v5 = function(e8) {
      var r5 = e8.axis, t8 = e8.width, i5 = e8.height, n5 = e8.position, o5 = e8.offsetX, a6 = e8.offsetY, l4 = e8.orientation, s5 = 0, d4 = 0, u4 = "vertical" === l4 ? -90 : 0, c10 = "start";
      if ("x" === r5)
        switch (n5) {
          case "top-left":
            s5 = -o5, d4 = a6, c10 = "end";
          ...
          case "top":
            ...
            break;
          case "top-right":
            s5 = o5, d4 = a6, c10 = "horizontal" === l4 ? "start" : "end";
            break;
          case "right":
            s5 = o5, d4 = i5 / 2, c10 = "horizontal" === l4 ? "start" : "middle";
            break;
          case "bottom-right":
            s5 = o5, d4 = i5 - a6, c10 = "start";
            break;
          case "bottom":
            d4 = i5 + a6, c10 = "horizontal" === l4 ? "middle" : "end";
            break;
          case "bottom-left":
            d4 = i5 - a6, s5 = -o5, c10 = "horizontal" === l4 ? "end" : "start";
            break;
          case "left":
        ...
        switch (n5) {
          case "top-left":
            s5 = o5, d4 = -a6, c10 = "start";
            break;
          case "top":
            s5 = t8 / 2, d4 = -a6, c10 = "horizontal" === l4 ? "middle" : "start";
            break;
          case "top-right":
            s5 = t8 - o5, d4 = -a6, c10 = "horizontal" === l4 ? "end" : "start";
            break;
          case "right":
            s5 = t8 + o5, c10 = "horizontal" === l4 ? "start" : "middle";
            break;
          case "bottom-right":
            s5 = t8 - o5, d4 = a6, c10 = "end";
            break;
          case "bottom":
            s5 = t8 / 2, d4 = a6, c10 = "horizontal" === l4 ? "middle" : "end";
            break;
          case "bottom-left":
            s5 = o5, d4 = a6, c10 = "horizontal" === l4 ? "start" : "end";
            break;
    ...
    }({ axis: i4, width: r4, height: t7, position: d3, offsetX: u3, offsetY: c9, orientation: f3 });
...
var Pi = (0, import_react16.memo)(zi);
var Ti = function(e7) {
  var r4 = e7.markers, t7 = e7.width, i4 = e7.height, n4 = e7.xScale, o4 = e7.yScale;
  return r4 && 0 !== r4.length ? r4.map(function(e8, r5) {
    return (0, import_jsx_runtime2.jsx)(Pi, Mr({}, e8, { width: t7, height: i4, scale: "y" === e8.axis ? o4 : n4 }), r5);
  }) : null;
};
...
var Si = (0, import_react16.memo)(Ti);
var Gi = function(e7) {
...
var Ki = function(e7, r4, t7, i4) {
  var n4 = void 0 === i4 ? {} : i4, o4 = n4.dataKey, a5 = n4.colorKey, l3 = void 0 === a5 ? "color" : a5, s4 = n4.targetKey, d3 = void 0 === s4 ? "fill" : s4, u3 = [], c9 = {};
        ...
        if (f3) {
          if (Xi.includes(f3.type))
            if ("inherit" === f3.background || "inherit" === f3.color) {
              ...
              "inherit" === f3.background && (b4 = b4 + ".bg." + p4, h3 = p4), "inherit" === f3.color && (b4 = b4 + ".fg." + p4, g3 = p4), (0, import_set2.default)(r5, d3, "url(#" + b4 + ")"), c9[b4] || (u3.push(Mr({}, f3, { id: b4, background: h3, color: g3 })), c9[b4] = 1);
            } else
            ...
            if (f3.colors.map(function(e8) {
              ...
              var m4 = (0, import_get.default)(r5, l3), R = a6, q3 = Mr({}, f3, { colors: f3.colors.map(function(e8, r6) {
                return "inherit" !== e8.color ? e8 : (R = R + "." + r6 + "." + m4, Mr({}, e8, { color: "inherit" === e8.color ? m4 : e8.color }));
              }) });
              q3.id = R, (0, import_set2.default)(r5, d3, "url(#" + R + ")"), c9[R] || (u3.push(q3), c9[R] = 1);
            } else
              (0, import_set2.default)(r5, d3, "url(#" + a6 + ")");
          }
        }
...
function xyz2lab2(t7) {
  return t7 > t32 ? Math.pow(t7, 1 / 3) : t7 / t22 + t03;
}
function lab2xyz2(t7) {
  return t7 > t13 ? t7 * t7 * t7 : t22 * (t7 - t03);
}
...
function cubehelixConvert2(o4) {
  ...
  if (!(o4 instanceof Rgb2))
    o4 = rgbConvert2(o4);
  var r4 = o4.r / 255, g3 = o4.g / 255, b4 = o4.b / 255, l3 = (BC_DA2 * b4 + ED2 * r4 - EB2 * g3) / (BC_DA2 + ED2 - EB2), bl = b4 - l3, k5 = (E3 * (g3 - l3) - C4 * bl) / D2, s4 = Math.sqrt(k5 * k5 + bl * bl) / (E3 * l3 * (1 - l3)), h3 = s4 ? Math.atan2(k5, bl) * degrees3 - 120 : NaN;
...
define_default2(Cubehelix2, cubehelix3, extend2(Color2, {
  ...
  rgb() {
    var h3 = isNaN(this.h) ? 0 : (this.h + 120) * radians2, l3 = +this.l, a5 = isNaN(this.s) ? 0 : this.s * l3 * (1 - l3), cosh2 = Math.cos(h3), sinh2 = Math.sin(h3);
    return new Rgb2(
      255 * (l3 + a5 * (A3 * cosh2 + B2 * sinh2)),
      255 * (l3 + a5 * (C4 * cosh2 + D2 * sinh2)),
      255 * (l3 + a5 * (E3 * cosh2)),
      this.opacity
    );
  }
...
var Qe = function(e7, r4) {
  if ("function" == typeof e7)
    return e7;
  if ((0, import_lodash2.isPlainObject)(e7)) {
    if (function(e8) {
      return void 0 !== e8.theme;
    }(e7)) {
      if (void 0 === r4)
        throw new Error("Unable to use color from theme as no theme was provided");
      var n4 = (0, import_lodash2.get)(r4, e7.theme);
      if (void 0 === n4)
    ...
    if (function(e8) {
      ...
      var t7 = function(r5) {
        return (0, import_lodash2.get)(r5, e7.from);
      };
...
var fr = function(e7, r4) {
  ...
  var n4 = "function" == typeof r4 ? r4 : function(e8) {
    return (0, import_lodash2.get)(e8, r4);
  };
  if (Array.isArray(e7)) {
  ...
  if ((0, import_lodash2.isPlainObject)(e7)) {
    if (function(e8) {
      ...
      return function(r5) {
        return (0, import_lodash2.get)(r5, e7.datum);
      };
    if (function(e8) {
      return void 0 !== e8.scheme;
    }(e7)) {
      if (Fe(e7.scheme)) {
        var i4 = ordinal($e2[e7.scheme]), u3 = function(e8) {
          return i4(n4(e8));
        };
      ...
      if (He(e7.scheme)) {
        ...
        var a5 = ordinal($e2[e7.scheme][e7.size || 11]), l3 = function(e8) {
          return a5(n4(e8));
        };
      ...
      if (Je(e7.scheme)) {
        ...
        var s4 = ordinal($e2[e7.scheme][e7.size || 9]), c9 = function(e8) {
          return s4(n4(e8));
        };
...
var b2 = function(n4) {
  var e7 = n4.label, r4 = n4.style, a5 = Ut();
...
var L = function(t7, n4) {
  return t7.filter(function(t8) {
    return Math.abs(ai(t8.arc.endAngle - t8.arc.startAngle)) >= n4;
  });
};
var E4 = { startAngle: { enter: function(t7) {
...
var T2 = function(t7, n4) {
  var e7 = li(t7) - Math.PI / 2, r4 = t7.innerRadius + (t7.outerRadius - t7.innerRadius) * n4;
  return si(e7, r4);
};
var j2 = function(t7) {
...
var W2 = function(t7, n4, r4, i4) {
  ...
  var a5 = $r(), o4 = a5.animate, u3 = a5.config, l3 = I(r4, i4);
...
var B3 = function(t7) {
  var n4 = t7.center, e7 = t7.data, r4 = t7.transitionMode, o4 = t7.label, u3 = t7.radiusOffset, l3 = t7.skipAngle, s4 = t7.textColor, f3 = t7.component, c9 = void 0 === f3 ? b2 : f3, g3 = Li(o4), h3 = Ut(), x6 = We(s4, h3), m4 = (0, import_react18.useMemo)(function() {
    return e7.filter(function(t8) {
      return Math.abs(ai(t8.arc.endAngle - t8.arc.startAngle)) >= l3;
    });
  }, [e7, l3]), y4 = W2(m4, u3, r4), k5 = y4.transition, C7 = y4.interpolate, L2 = c9;
  return (0, import_jsx_runtime3.jsx)("g", { transform: "translate(" + n4[0] + "," + n4[1] + ")", children: k5(function(t8, n5) {
    return (0, import_react18.createElement)(L2, { key: n5.id, datum: n5, label: g3(n5), style: M2({}, t8, { transform: C7(t8.startAngle, t8.endAngle, t8.innerRadius, t8.outerRadius), textColor: x6(n5) }) });
  }) });
};
...
var z3 = function(t7) {
  var n4 = t7.data, e7 = t7.offset, r4 = t7.skipAngle, a5 = t7.label, o4 = t7.textColor, u3 = Li(a5), l3 = Ut(), s4 = We(o4, l3), f3 = (0, import_react18.useCallback)(function(t8) {
...
var q = function(t7) {
  var n4 = C5(t7.startAngle + (t7.endAngle - t7.startAngle) / 2 - Math.PI / 2);
  return n4 < Math.PI / 2 || n4 > 1.5 * Math.PI ? "start" : "end";
};
var D3 = function(t7, n4, e7, r4) {
  var i4, a5, u3 = C5(t7.startAngle + (t7.endAngle - t7.startAngle) / 2 - Math.PI / 2), l3 = si(u3, t7.outerRadius + n4), s4 = si(u3, t7.outerRadius + n4 + e7);
...
var J = function(t7, e7, r4, i4, a5, o4, u3) {
  return to2([t7, e7, r4, i4, a5, o4, u3], function(t8, n4, e8, r5, i5, a6, o5) {
    var u4 = D3({ startAngle: t8, endAngle: n4, innerRadius: e8, outerRadius: r5 }, i5, a6, o5).points;
    return H(u4);
  });
};
var K3 = function(t7, e7, r4, i4) {
...
var N2 = function(t7, e7, r4, i4, a5, o4, u3, l3) {
  return to2([t7, e7, r4, i4, a5, o4, u3, l3], function(t8, n4, e8, r5, i5, a6, o5, u4) {
    var l4 = D3({ startAngle: t8, endAngle: n4, innerRadius: e8, outerRadius: r5 }, i5, a6, o5), s4 = l4.points, d3 = l4.side, f3 = s4[2];
    return "before" === d3 ? f3.x -= u4 : f3.x += u4, "translate(" + f3.x + "," + f3.y + ")";
  });
};
var Q = function(t7) {
  var n4 = t7.data, r4 = t7.offset, a5 = void 0 === r4 ? 0 : r4, o4 = t7.diagonalLength, u3 = t7.straightLength, l3 = t7.skipAngle, d3 = void 0 === l3 ? 0 : l3, f3 = t7.textOffset, c9 = t7.linkColor, g3 = t7.textColor, p4 = $r(), h3 = p4.animate, A5 = p4.config, x6 = Ut(), m4 = We(c9, x6), y4 = We(g3, x6), M3 = function(t8, n5) {
    return (0, import_react18.useMemo)(function() {
      return L(t8, n5);
    }, [t8, n5]);
  ...
  return { transition: useTransition(M3, { keys: function(t8) {
    return t8.id;
  }, initial: k5.update, from: k5.enter, enter: k5.update, update: k5.update, leave: k5.leave, config: A5, immediate: !h3 }), interpolateLink: J, interpolateTextAnchor: K3, interpolateTextPosition: N2 };
};
var U = function(t7) {
  var n4 = t7.center, e7 = t7.data, r4 = t7.label, i4 = t7.skipAngle, a5 = t7.offset, o4 = t7.diagonalLength, u3 = t7.straightLength, l3 = t7.strokeWidth, s4 = t7.textOffset, f3 = t7.textColor, c9 = t7.linkColor, g3 = t7.component, h3 = void 0 === g3 ? G : g3, v5 = Li(r4), x6 = Q({ data: e7, skipAngle: i4, offset: a5, diagonalLength: o4, straightLength: u3, textOffset: s4, linkColor: c9, textColor: f3 }), R = x6.transition, m4 = x6.interpolateLink, y4 = x6.interpolateTextAnchor, k5 = x6.interpolateTextPosition, b4 = h3;
...
var V2 = function(t7, n4, e7, r4) {
  t7.textBaseline = "middle", t7.font = e7.labels.text.fontSize + "px " + e7.labels.text.fontFamily, n4.forEach(function(n5) {
    t7.fillStyle = n5.textColor, t7.textAlign = pi3.canvas.align[n5.textAnchor], t7.fillText("" + n5.label, n5.x, n5.y), t7.beginPath(), t7.strokeStyle = n5.linkColor, t7.lineWidth = r4, n5.points.forEach(function(n6, e8) {
...
var X = function(t7) {
  var n4 = t7.data, e7 = t7.skipAngle, r4 = void 0 === e7 ? 0 : e7, i4 = t7.offset, o4 = void 0 === i4 ? 0.5 : i4, u3 = t7.diagonalLength, l3 = t7.straightLength, s4 = t7.computeExtraProps, d3 = void 0 === s4 ? function() {
    ...
    return n4.filter(function(t8) {
      return Math.abs(ai(t8.arc.endAngle - t8.arc.startAngle)) >= r4;
    }).map(function(t8) {
      return M2({}, D3(t8.arc, o4, u3, l3), { data: t8 });
    });
  }, [n4, r4, o4, u3, l3]);
  return (0, import_react18.useMemo)(function() {
...
var Y = function(t7) {
  var n4 = t7.data, e7 = t7.skipAngle, r4 = t7.offset, a5 = t7.diagonalLength, o4 = t7.straightLength, u3 = t7.textOffset, l3 = void 0 === u3 ? 0 : u3, s4 = t7.label, f3 = t7.linkColor, c9 = t7.textColor, g3 = Li(s4), p4 = Ut(), h3 = We(f3, p4), v5 = We(c9, p4), A5 = (0, import_react18.useCallback)(function(t8) {
  ...
  return X({ data: n4, skipAngle: e7, offset: r4, diagonalLength: a5, straightLength: o4, computeExtraProps: A5 });
};
var tt2 = function(n4) {
...
var nt2 = function(t7, e7, r4, i4, a5) {
  return to2([t7, e7, r4, i4], function(t8, n4, e8, r5) {
    return a5({ startAngle: t8, endAngle: n4, innerRadius: Math.max(0, e8), outerRadius: Math.max(0, r5) });
  });
};
var et = function(t7, n4, r4) {
  void 0 === n4 && (n4 = "innerRadius");
  var i4 = $r(), a5 = i4.animate, o4 = i4.config, u3 = I(n4, r4);
  return { transition: useTransition(t7, { keys: function(t8) {
    return t8.id;
  }, initial: u3.update, from: u3.enter, enter: u3.update, update: u3.update, leave: u3.leave, config: o4, immediate: !a5 }), interpolate: nt2 };
};
var rt2 = function(t7) {
  var n4 = t7.center, e7 = t7.data, r4 = t7.arcGenerator, a5 = t7.borderWidth, o4 = t7.borderColor, u3 = t7.onClick, l3 = t7.onMouseEnter, s4 = t7.onMouseMove, d3 = t7.onMouseLeave, f3 = t7.transitionMode, c9 = t7.component, g3 = void 0 === c9 ? tt2 : c9, h3 = Ut(), v5 = We(o4, h3), x6 = et(e7, f3, { enter: function(t8) {
...
var it = function(t7, n4, e7, r4, i4, a5) {
  void 0 === a5 && (a5 = true);
  var l3 = [], s4 = si(oi(r4), e7);
  l3.push([s4.x, s4.y]);
  var d3 = si(oi(i4), e7);
  l3.push([d3.x, d3.y]);
  ...
  var g3 = l3.map(function(t8) {
    ...
    return t8[1];
  }), h3 = Math.min.apply(Math, g3), v5 = Math.max.apply(Math, g3), A5 = Math.min.apply(Math, p4);
  return { points: l3, x: h3, y: A5, width: v5 - h3, height: Math.max.apply(Math, p4) - A5 };
};
var at = function(t7, n4, e7, r4, i4, a5) {
  var o4 = Yi(i4, a5, t7, n4);
  return o4 < e7 && o4 > r4;
};
var ot = function(t7, n4, e7, r4, i4, a5, o4) {
  if (at(t7, n4, e7, r4, a5, o4)) {
    var u3 = Ai(a5, o4, t7, n4);
...
var m3 = function(e7) {
  var i4 = e7.x, n4 = e7.y, o4 = e7.size, r4 = e7.fill, l3 = e7.opacity, a5 = void 0 === l3 ? 1 : l3, c9 = e7.borderWidth, s4 = void 0 === c9 ? 0 : c9, d3 = e7.borderColor;
...
var k4 = function(t7) {
  ...
  var c9 = "number" == typeof o4 ? { top: o4, right: o4, bottom: o4, left: o4 } : p3({}, b3, o4), s4 = c9.left + c9.right, d3 = c9.top + c9.bottom, h3 = l3 + s4, g3 = a5 + d3, m4 = (r4 - 1) * n4;
  return "row" === i4 ? h3 = l3 * r4 + m4 + s4 : "column" === i4 && (g3 = a5 * r4 + m4 + d3), { width: h3, height: g3, padding: c9 };
};
var x5 = function(t7) {
  var e7 = t7.anchor, i4 = t7.translateX, n4 = t7.translateY, o4 = t7.containerWidth, r4 = t7.containerHeight, l3 = t7.width, a5 = t7.height, c9 = i4, s4 = n4;
  switch (e7) {
    case "top":
      c9 += (o4 - l3) / 2;
      break;
    ...
    case "left":
      ...
      break;
    case "center":
      c9 += (o4 - l3) / 2, s4 += (r4 - a5) / 2;
  }
  return { x: c9, y: s4 };
};
var S2 = function(t7) {
  var e7, i4, n4, o4, r4, l3, a5 = t7.direction, c9 = t7.justify, s4 = t7.symbolSize, d3 = t7.symbolSpacing, h3 = t7.width, g3 = t7.height;
  switch (a5) {
    case "left-to-right":
      e7 = 0, i4 = (g3 - s4) / 2, o4 = g3 / 2, l3 = "central", c9 ? (n4 = h3, r4 = "end") : (n4 = s4 + d3, r4 = "start");
      break;
    case "right-to-left":
      e7 = h3 - s4, i4 = (g3 - s4) / 2, o4 = g3 / 2, l3 = "central", c9 ? (n4 = 0, r4 = "start") : (n4 = h3 - s4 - d3, r4 = "end");
      break;
    case "top-to-bottom":
      e7 = (h3 - s4) / 2, i4 = 0, n4 = h3 / 2, r4 = "middle", c9 ? (o4 = g3, l3 = "alphabetic") : (o4 = s4 + d3, l3 = "text-before-edge");
      break;
    case "bottom-to-top":
      e7 = (h3 - s4) / 2, i4 = g3 - s4, n4 = h3 / 2, r4 = "middle", c9 ? (o4 = 0, l3 = "text-before-edge") : (o4 = g3 - s4 - d3, l3 = "alphabetic");
  }
  return { symbolX: e7, symbolY: i4, labelX: n4, labelY: o4, labelAnchor: r4, labelAlignment: l3 };
};
var C6 = { circle: m3, diamond: f2, square: u2, triangle: v4 };
var B4 = function(i4) {
  var n4, r4, l3, c9, h3, g3, m4, f3, u3, v5, y4, b4 = i4.x, k5 = i4.y, x6 = i4.width, A5 = i4.height, W4 = i4.data, O3 = i4.direction, z5 = void 0 === O3 ? "left-to-right" : O3, B5 = i4.justify, w4 = void 0 !== B5 && B5, X4 = i4.textColor, Y4 = i4.background, H4 = void 0 === Y4 ? "transparent" : Y4, E5 = i4.opacity, j4 = void 0 === E5 ? 1 : E5, T4 = i4.symbolShape, L2 = void 0 === T4 ? "square" : T4, M3 = i4.symbolSize, F3 = void 0 === M3 ? 16 : M3, P4 = i4.symbolSpacing, R = void 0 === P4 ? 8 : P4, q3 = i4.symbolBorderWidth, V3 = void 0 === q3 ? 0 : q3, D5 = i4.symbolBorderColor, G2 = void 0 === D5 ? "transparent" : D5, I2 = i4.onClick, N4 = i4.onMouseEnter, _2 = i4.onMouseLeave, J3 = i4.toggleSerie, K5 = i4.effects, Q3 = (0, import_react19.useState)({}), U3 = Q3[0], Z2 = Q3[1], $2 = Ut(), tt3 = (0, import_react19.useCallback)(function(t7) {
    if (K5) {
      var e7 = K5.filter(function(t8) {
        return "hover" === t8.on;
    ...
    null == N4 || N4(W4, t7);
  }, [N4, W4, K5]), et2 = (0, import_react19.useCallback)(function(t7) {
    if (K5) {
      var e7 = K5.filter(function(t8) {
        return "hover" !== t8.on;
      }).reduce(function(t8, e8) {
    ...
    null == _2 || _2(W4, t7);
  }, [_2, W4, K5]), it2 = S2({ direction: z5, justify: w4, symbolSize: null != (n4 = U3.symbolSize) ? n4 : F3, symbolSpacing: R, width: x6, height: A5 }), nt3 = it2.symbolX, ot2 = it2.symbolY, rt3 = it2.labelX, lt2 = it2.labelY, at2 = it2.labelAnchor, ct2 = it2.labelAlignment, st = [I2, N4, _2, J3].some(function(t7) {
    return void 0 !== t7;
  }), dt = "function" == typeof L2 ? L2 : C6[L2];
  return (0, import_jsx_runtime4.jsxs)("g", { transform: "translate(" + b4 + "," + k5 + ")", style: { opacity: null != (r4 = U3.itemOpacity) ? r4 : j4 }, children: [(0, import_jsx_runtime4.jsx)("rect", { width: x6, height: A5, fill: null != (l3 = U3.itemBackground) ? l3 : H4, style: { cursor: st ? "pointer" : "auto" }, onClick: function(t7) {
    null == I2 || I2(W4, t7), null == J3 || J3(W4.id);
  }, onMouseEnter: tt3, onMouseLeave: et2 }), a3.createElement(dt, p3({ id: W4.id, x: nt3, y: ot2, size: null != (c9 = U3.symbolSize) ? c9 : F3, fill: null != (h3 = null != (g3 = W4.fill) ? g3 : W4.color) ? h3 : "black", borderWidth: null != (m4 = U3.symbolBorderWidth) ? m4 : V3, borderColor: null != (f3 = U3.symbolBorderColor) ? f3 : G2 }, W4.hidden ? $2.legends.hidden.symbol : void 0)), (0, import_jsx_runtime4.jsx)("text", { textAnchor: at2, style: p3({}, $2.legends.text, { fill: null != (u3 = null != (v5 = null != (y4 = U3.itemTextColor) ? y4 : X4) ? v5 : $2.legends.text.fill) ? u3 : "black", dominantBaseline: ct2, pointerEvents: "none", userSelect: "none" }, W4.hidden ? $2.legends.hidden.text : void 0), x: rt3, y: lt2, children: W4.label })] });
};
var w3 = function(e7) {
  var i4 = e7.data, n4 = e7.x, o4 = e7.y, r4 = e7.direction, l3 = e7.padding, a5 = void 0 === l3 ? 0 : l3, c9 = e7.justify, s4 = e7.effects, d3 = e7.itemWidth, h3 = e7.itemHeight, g3 = e7.itemDirection, m4 = void 0 === g3 ? "left-to-right" : g3, f3 = e7.itemsSpacing, u3 = void 0 === f3 ? 0 : f3, v5 = e7.itemTextColor, p4 = e7.itemBackground, y4 = void 0 === p4 ? "transparent" : p4, b4 = e7.itemOpacity, x6 = void 0 === b4 ? 1 : b4, S4 = e7.symbolShape, A5 = e7.symbolSize, W4 = e7.symbolSpacing, O3 = e7.symbolBorderWidth, z5 = e7.symbolBorderColor, C7 = e7.onClick, w4 = e7.onMouseEnter, X4 = e7.onMouseLeave, Y4 = e7.toggleSerie, H4 = k4({ itemCount: i4.length, itemWidth: d3, itemHeight: h3, itemsSpacing: u3, direction: r4, padding: a5 }).padding, E5 = "row" === r4 ? d3 + u3 : 0, j4 = "column" === r4 ? h3 + u3 : 0;
  return (0, import_jsx_runtime4.jsx)("g", { transform: "translate(" + n4 + "," + o4 + ")", children: i4.map(function(e8, i5) {
    return (0, import_jsx_runtime4.jsx)(B4, { data: e8, x: i5 * E5 + H4.left, y: i5 * j4 + H4.top, width: d3, height: h3, direction: m4, justify: c9, effects: s4, textColor: v5, background: y4, opacity: x6, symbolShape: S4, symbolSize: A5, symbolSpacing: W4, symbolBorderWidth: O3, symbolBorderColor: z5, onClick: C7, onMouseEnter: w4, onMouseLeave: X4, toggleSerie: Y4 }, i5);
  }) });
};
var X2 = function(e7) {
  var i4 = e7.data, n4 = e7.containerWidth, o4 = e7.containerHeight, r4 = e7.translateX, l3 = void 0 === r4 ? 0 : r4, a5 = e7.translateY, c9 = void 0 === a5 ? 0 : a5, s4 = e7.anchor, d3 = e7.direction, h3 = e7.padding, g3 = void 0 === h3 ? 0 : h3, m4 = e7.justify, f3 = e7.itemsSpacing, u3 = void 0 === f3 ? 0 : f3, v5 = e7.itemWidth, p4 = e7.itemHeight, y4 = e7.itemDirection, b4 = e7.itemTextColor, S4 = e7.itemBackground, A5 = e7.itemOpacity, W4 = e7.symbolShape, O3 = e7.symbolSize, z5 = e7.symbolSpacing, C7 = e7.symbolBorderWidth, B5 = e7.symbolBorderColor, X4 = e7.onClick, Y4 = e7.onMouseEnter, H4 = e7.onMouseLeave, E5 = e7.toggleSerie, j4 = e7.effects, T4 = k4({ itemCount: i4.length, itemsSpacing: u3, itemWidth: v5, itemHeight: p4, direction: d3, padding: g3 }), L2 = T4.width, M3 = T4.height, F3 = x5({ anchor: s4, translateX: l3, translateY: c9, containerWidth: n4, containerHeight: o4, width: L2, height: M3 }), P4 = F3.x, R = F3.y;
  return (0, import_jsx_runtime4.jsx)(w3, { data: i4, x: P4, y: R, direction: d3, padding: g3, justify: m4, effects: j4, itemsSpacing: u3, itemWidth: v5, itemHeight: p4, itemDirection: y4, itemTextColor: b4, itemBackground: S4, itemOpacity: A5, symbolShape: W4, symbolSize: O3, symbolSpacing: z5, symbolBorderWidth: C7, symbolBorderColor: B5, onClick: X4, onMouseEnter: Y4, onMouseLeave: H4, toggleSerie: "boolean" == typeof E5 ? void 0 : E5 });
};
var Y2 = { start: "left", middle: "center", end: "right" };
var H2 = function(t7, e7) {
  var i4 = e7.data, n4 = e7.containerWidth, o4 = e7.containerHeight, r4 = e7.translateX, l3 = void 0 === r4 ? 0 : r4, a5 = e7.translateY, c9 = void 0 === a5 ? 0 : a5, s4 = e7.anchor, d3 = e7.direction, h3 = e7.padding, g3 = void 0 === h3 ? 0 : h3, m4 = e7.justify, f3 = void 0 !== m4 && m4, u3 = e7.itemsSpacing, v5 = void 0 === u3 ? 0 : u3, p4 = e7.itemWidth, y4 = e7.itemHeight, b4 = e7.itemDirection, A5 = void 0 === b4 ? "left-to-right" : b4, W4 = e7.itemTextColor, O3 = e7.symbolSize, z5 = void 0 === O3 ? 16 : O3, C7 = e7.symbolSpacing, B5 = void 0 === C7 ? 8 : C7, w4 = e7.theme, X4 = k4({ itemCount: i4.length, itemWidth: p4, itemHeight: y4, itemsSpacing: v5, direction: d3, padding: g3 }), H4 = X4.width, E5 = X4.height, j4 = X4.padding, T4 = x5({ anchor: s4, translateX: l3, translateY: c9, containerWidth: n4, containerHeight: o4, width: H4, height: E5 }), L2 = T4.x, M3 = T4.y, F3 = "row" === d3 ? p4 + v5 : 0, P4 = "column" === d3 ? y4 + v5 : 0;
  t7.save(), t7.translate(L2, M3), t7.font = w4.legends.text.fontSize + "px " + (w4.legends.text.fontFamily || "sans-serif"), i4.forEach(function(e8, i5) {
    var n5, o5, r5 = i5 * F3 + j4.left, l4 = i5 * P4 + j4.top, a6 = S2({ direction: A5, justify: f3, symbolSize: z5, symbolSpacing: B5, width: p4, height: y4 }), c10 = a6.symbolX, s5 = a6.symbolY, d4 = a6.labelX, h4 = a6.labelY, g4 = a6.labelAnchor, m5 = a6.labelAlignment;
    t7.fillStyle = null != (n5 = e8.color) ? n5 : "black", t7.fillRect(r5 + c10, l4 + s5, z5, z5), t7.textAlign = Y2[g4], "central" === m5 && (t7.textBaseline = "middle"), t7.fillStyle = null != (o5 = null != W4 ? W4 : w4.legends.text.fill) ? o5 : "black", t7.fillText(String(e8.label), r5 + d4, l4 + h4);
  }), t7.restore();
};
...
function D4() {
  return D4 = Object.assign ? Object.assign.bind() : function(e7) {
    for (var i4 = 1; i4 < arguments.length; i4++) {
      var n4 = arguments[i4];
      for (var t7 in n4)
        Object.prototype.hasOwnProperty.call(n4, t7) && (e7[t7] = n4[t7]);
...
function F2(e7, i4) {
  if (null == e7)
    return {};
  var n4, t7, r4 = {}, a5 = Object.keys(e7);
  for (t7 = 0; t7 < a5.length; t7++)
    n4 = a5[t7], i4.indexOf(n4) >= 0 || (r4[n4] = e7[n4]);
  return r4;
}
var H3;
var X3 = function(e7) {
  var i4 = e7.width, n4 = e7.height, t7 = e7.legends, r4 = e7.data, a5 = e7.toggleSerie;
  return (0, import_jsx_runtime5.jsx)(import_jsx_runtime5.Fragment, { children: t7.map(function(e8, t8) {
    var o4;
    return (0, import_jsx_runtime5.jsx)(X2, D4({}, e8, { containerWidth: i4, containerHeight: n4, data: null != (o4 = e8.data) ? o4 : r4, toggleSerie: e8.toggleSerie ? a5 : void 0 }), t8);
  }) });
};
var Y3 = { id: "id", value: "value", sortByValue: false, innerRadius: 0, padAngle: 0, cornerRadius: 0, layers: ["arcLinkLabels", "arcs", "arcLabels", "legends"], startAngle: 0, endAngle: 360, fit: true, activeInnerRadiusOffset: 0, activeOuterRadiusOffset: 0, borderWidth: 0, borderColor: { from: "color", modifiers: [["darker", 1]] }, enableArcLabels: true, arcLabel: "formattedValue", arcLabelsSkipAngle: 0, arcLabelsRadiusOffset: 0.5, arcLabelsTextColor: { theme: "labels.text.fill" }, enableArcLinkLabels: true, arcLinkLabel: "id", arcLinkLabelsSkipAngle: 0, arcLinkLabelsOffset: 0, arcLinkLabelsDiagonalLength: 16, arcLinkLabelsStraightLength: 24, arcLinkLabelsThickness: 1, arcLinkLabelsTextOffset: 6, arcLinkLabelsTextColor: { theme: "labels.text.fill" }, arcLinkLabelsColor: { theme: "axis.ticks.line.stroke" }, colors: { scheme: "nivo" }, defs: [], fill: [], isInteractive: true, animate: true, motionConfig: "gentle", transitionMode: "innerRadius", tooltip: function(e7) {
  var i4 = e7.datum;
  return (0, import_jsx_runtime5.jsx)(w, { id: i4.id, value: i4.formattedValue, enableChip: true, color: i4.color });
}, legends: [], role: "img", pixelRatio: "undefined" != typeof window && null != (H3 = window.devicePixelRatio) ? H3 : 1 };
var j3 = ["points"];
var P3 = function(i4) {
  var n4 = i4.data, t7 = i4.id, r4 = void 0 === t7 ? Y3.id : t7, a5 = i4.value, o4 = void 0 === a5 ? Y3.value : a5, s4 = i4.valueFormat, c9 = i4.colors, u3 = void 0 === c9 ? Y3.colors : c9, v5 = Li(r4), f3 = Li(o4), g3 = Yt(s4), L2 = pr(u3, "id");
  return (0, import_react20.useMemo)(function() {
    return n4.map(function(e7) {
      var i5, n5 = v5(e7), t8 = f3(e7), r5 = { id: n5, label: null != (i5 = e7.label) ? i5 : n5, hidden: false, value: t8, formattedValue: g3(t8), data: e7 };
      return D4({}, r5, { color: L2(r5) });
    });
  }, [n4, v5, f3, g3, L2]);
};
var q2 = function(i4) {
  var n4 = i4.data, t7 = i4.startAngle, r4 = i4.endAngle, a5 = i4.innerRadius, o4 = i4.outerRadius, d3 = i4.padAngle, l3 = i4.sortByValue, u3 = i4.activeId, v5 = i4.activeInnerRadiusOffset, f3 = i4.activeOuterRadiusOffset, g3 = i4.hiddenIds, L2 = (0, import_react20.useMemo)(function() {
    var e7 = pie_default().value(function(e8) {
      return e8.value;
    }).startAngle(oi(t7)).endAngle(oi(r4)).padAngle(oi(d3));
    return l3 || e7.sortValues(null), e7;
  }, [t7, r4, d3, l3]);
  return (0, import_react20.useMemo)(function() {
    var e7 = n4.filter(function(e8) {
      return !g3.includes(e8.id);
    });
    return { dataWithArc: L2(e7).map(function(e8) {
      var i5 = Math.abs(e8.endAngle - e8.startAngle);
      return D4({}, e8.data, { arc: { index: e8.index, startAngle: e8.startAngle, endAngle: e8.endAngle, innerRadius: u3 === e8.data.id ? a5 - v5 : a5, outerRadius: u3 === e8.data.id ? o4 + f3 : o4, thickness: o4 - a5, padAngle: e8.padAngle, angle: i5, angleDeg: ai(i5) } });
    }), legendData: n4.map(function(e8) {
      return D4({}, e8, { hidden: g3.includes(e8.id) });
    }) };
  }, [L2, n4, g3, u3, a5, v5, o4, f3]);
};
var z4 = function(e7) {
  var t7 = e7.data, r4 = e7.radius, a5 = e7.innerRadius, o4 = e7.startAngle, d3 = void 0 === o4 ? Y3.startAngle : o4, l3 = e7.endAngle, c9 = void 0 === l3 ? Y3.endAngle : l3, u3 = e7.padAngle, v5 = void 0 === u3 ? Y3.padAngle : u3, f3 = e7.sortByValue, g3 = void 0 === f3 ? Y3.sortByValue : f3, L2 = e7.cornerRadius, h3 = void 0 === L2 ? Y3.cornerRadius : L2, b4 = e7.activeInnerRadiusOffset, k5 = void 0 === b4 ? Y3.activeInnerRadiusOffset : b4, A5 = e7.activeOuterRadiusOffset, R = void 0 === A5 ? Y3.activeOuterRadiusOffset : A5, m4 = (0, import_react20.useState)(null), O3 = m4[0], C7 = m4[1], I2 = (0, import_react20.useState)([]), x6 = I2[0], M3 = I2[1], y4 = q2({ data: t7, startAngle: d3, endAngle: c9, innerRadius: a5, outerRadius: r4, padAngle: v5, sortByValue: g3, activeId: O3, activeInnerRadiusOffset: k5, activeOuterRadiusOffset: R, hiddenIds: x6 }), w4 = (0, import_react20.useCallback)(function(e8) {
    M3(function(i4) {
      return i4.indexOf(e8) > -1 ? i4.filter(function(i5) {
        return i5 !== e8;
      }) : [].concat(i4, [e8]);
    });
  }, []);
  return D4({}, y4, { arcGenerator: lt({ cornerRadius: h3, padAngle: oi(v5) }), setActiveId: C7, toggleSerie: w4 });
};
var J2 = function(t7) {
  var r4 = t7.data, a5 = t7.width, o4 = t7.height, d3 = t7.innerRadius, l3 = void 0 === d3 ? Y3.innerRadius : d3, c9 = t7.startAngle, u3 = void 0 === c9 ? Y3.startAngle : c9, v5 = t7.endAngle, f3 = void 0 === v5 ? Y3.endAngle : v5, g3 = t7.padAngle, L2 = void 0 === g3 ? Y3.padAngle : g3, h3 = t7.sortByValue, b4 = void 0 === h3 ? Y3.sortByValue : h3, A5 = t7.cornerRadius, R = void 0 === A5 ? Y3.cornerRadius : A5, m4 = t7.fit, O3 = void 0 === m4 ? Y3.fit : m4, C7 = t7.activeInnerRadiusOffset, I2 = void 0 === C7 ? Y3.activeInnerRadiusOffset : C7, x6 = t7.activeOuterRadiusOffset, M3 = void 0 === x6 ? Y3.activeOuterRadiusOffset : x6, y4 = (0, import_react20.useState)(null), w4 = y4[0], W4 = y4[1], S4 = (0, import_react20.useState)([]), T4 = S4[0], V3 = S4[1], B5 = (0, import_react20.useMemo)(function() {
    var e7, i4 = Math.min(a5, o4) / 2, n4 = i4 * Math.min(l3, 1), t8 = a5 / 2, r5 = o4 / 2;
    if (O3) {
      var d4 = it(t8, r5, i4, u3 - 90, f3 - 90), s4 = d4.points, c10 = F2(d4, j3), v6 = Math.min(a5 / c10.width, o4 / c10.height), g4 = { width: c10.width * v6, height: c10.height * v6 };
      g4.x = (a5 - g4.width) / 2, g4.y = (o4 - g4.height) / 2, t8 = (t8 - c10.x) / c10.width * c10.width * v6 + g4.x, r5 = (r5 - c10.y) / c10.height * c10.height * v6 + g4.y, e7 = { box: c10, ratio: v6, points: s4 }, i4 *= v6, n4 *= v6;
    }
    return { centerX: t8, centerY: r5, radius: i4, innerRadius: n4, debug: e7 };
  }, [a5, o4, l3, u3, f3, O3, R]), G2 = q2({ data: r4, startAngle: u3, endAngle: f3, innerRadius: B5.innerRadius, outerRadius: B5.radius, padAngle: L2, sortByValue: b4, activeId: w4, activeInnerRadiusOffset: I2, activeOuterRadiusOffset: M3, hiddenIds: T4 }), E5 = (0, import_react20.useCallback)(function(e7) {
    V3(function(i4) {
      return i4.indexOf(e7) > -1 ? i4.filter(function(i5) {
        return i5 !== e7;
      }) : [].concat(i4, [e7]);
    });
  }, []);
  return D4({ arcGenerator: lt({ cornerRadius: R, padAngle: oi(L2) }), setActiveId: W4, toggleSerie: E5 }, G2, B5);
};
var K4 = function(i4) {
  var n4 = i4.dataWithArc, t7 = i4.arcGenerator, r4 = i4.centerX, a5 = i4.centerY, o4 = i4.radius, d3 = i4.innerRadius;
  return (0, import_react20.useMemo)(function() {
    return { dataWithArc: n4, arcGenerator: t7, centerX: r4, centerY: a5, radius: o4, innerRadius: d3 };
  }, [n4, t7, r4, a5, o4, d3]);
};
var N3 = function(i4) {
  var n4 = i4.center, r4 = i4.data, a5 = i4.arcGenerator, o4 = i4.borderWidth, d3 = i4.borderColor, l3 = i4.isInteractive, s4 = i4.onClick, c9 = i4.onMouseEnter, u3 = i4.onMouseMove, v5 = i4.onMouseLeave, f3 = i4.setActiveId, g3 = i4.tooltip, L2 = i4.transitionMode, h3 = k(), b4 = h3.showTooltipFromEvent, p4 = h3.hideTooltip, k5 = (0, import_react20.useMemo)(function() {
    if (l3)
      return function(e7, i5) {
        null == s4 || s4(e7, i5);
      };
  }, [l3, s4]), R = (0, import_react20.useMemo)(function() {
    if (l3)
      return function(e7, i5) {
        b4((0, import_react20.createElement)(g3, { datum: e7 }), i5), f3(e7.id), null == c9 || c9(e7, i5);
      };
  }, [l3, b4, f3, c9, g3]), m4 = (0, import_react20.useMemo)(function() {
    if (l3)
      return function(e7, i5) {
        b4((0, import_react20.createElement)(g3, { datum: e7 }), i5), null == u3 || u3(e7, i5);
      };
  }, [l3, b4, u3, g3]), O3 = (0, import_react20.useMemo)(function() {
    if (l3)
      return function(e7, i5) {
        p4(), f3(null), null == v5 || v5(e7, i5);
      };
  }, [l3, p4, f3, v5]);
  return (0, import_jsx_runtime5.jsx)(rt2, { center: n4, data: r4, arcGenerator: a5, borderWidth: o4, borderColor: d3, transitionMode: L2, onClick: k5, onMouseEnter: R, onMouseMove: m4, onMouseLeave: O3 });
};
var Q2 = ["isInteractive", "animate", "motionConfig", "theme", "renderWrapper"];
var U2 = function(e7) {
  var i4 = e7.data, n4 = e7.id, a5 = void 0 === n4 ? Y3.id : n4, o4 = e7.value, d3 = void 0 === o4 ? Y3.value : o4, l3 = e7.valueFormat, s4 = e7.sortByValue, c9 = void 0 === s4 ? Y3.sortByValue : s4, u3 = e7.layers, L2 = void 0 === u3 ? Y3.layers : u3, h3 = e7.startAngle, b4 = void 0 === h3 ? Y3.startAngle : h3, p4 = e7.endAngle, k5 = void 0 === p4 ? Y3.endAngle : p4, A5 = e7.padAngle, O3 = void 0 === A5 ? Y3.padAngle : A5, C7 = e7.fit, I2 = void 0 === C7 ? Y3.fit : C7, x6 = e7.innerRadius, M3 = void 0 === x6 ? Y3.innerRadius : x6, y4 = e7.cornerRadius, w4 = void 0 === y4 ? Y3.cornerRadius : y4, S4 = e7.activeInnerRadiusOffset, T4 = void 0 === S4 ? Y3.activeInnerRadiusOffset : S4, V3 = e7.activeOuterRadiusOffset, B5 = void 0 === V3 ? Y3.activeOuterRadiusOffset : V3, G2 = e7.width, E5 = e7.height, D5 = e7.margin, F3 = e7.colors, H4 = void 0 === F3 ? Y3.colors : F3, j4 = e7.borderWidth, q3 = void 0 === j4 ? Y3.borderWidth : j4, z5 = e7.borderColor, Q3 = void 0 === z5 ? Y3.borderColor : z5, U3 = e7.enableArcLabels, Z2 = void 0 === U3 ? Y3.enableArcLabels : U3, $2 = e7.arcLabel, _2 = void 0 === $2 ? Y3.arcLabel : $2, ee2 = e7.arcLabelsSkipAngle, ie2 = void 0 === ee2 ? Y3.arcLabelsSkipAngle : ee2, ne2 = e7.arcLabelsTextColor, te = void 0 === ne2 ? Y3.arcLabelsTextColor : ne2, re3 = e7.arcLabelsRadiusOffset, ae = void 0 === re3 ? Y3.arcLabelsRadiusOffset : re3, oe = e7.arcLabelsComponent, de = e7.enableArcLinkLabels, le = void 0 === de ? Y3.enableArcLinkLabels : de, se = e7.arcLinkLabel, ce = void 0 === se ? Y3.arcLinkLabel : se, ue = e7.arcLinkLabelsSkipAngle, ve = void 0 === ue ? Y3.arcLinkLabelsSkipAngle : ue, fe = e7.arcLinkLabelsOffset, ge = void 0 === fe ? Y3.arcLinkLabelsOffset : fe, Le2 = e7.arcLinkLabelsDiagonalLength, he = void 0 === Le2 ? Y3.arcLinkLabelsDiagonalLength : Le2, be = e7.arcLinkLabelsStraightLength, pe = void 0 === be ? Y3.arcLinkLabelsStraightLength : be, ke = e7.arcLinkLabelsThickness, Ae = void 0 === ke ? Y3.arcLinkLabelsThickness : ke, Re2 = e7.arcLinkLabelsTextOffset, me = void 0 === Re2 ? Y3.arcLinkLabelsTextOffset : Re2, Oe2 = e7.arcLinkLabelsTextColor, Ce2 = void 0 === Oe2 ? Y3.arcLinkLabelsTextColor : Oe2, Ie = e7.arcLinkLabelsColor, xe = void 0 === Ie ? Y3.arcLinkLabelsColor : Ie, Me2 = e7.arcLinkLabelComponent, ye = e7.defs, we2 = void 0 === ye ? Y3.defs : ye, We2 = e7.fill, Se2 = void 0 === We2 ? Y3.fill : We2, Te2 = e7.isInteractive, Ve2 = void 0 === Te2 ? Y3.isInteractive : Te2, Be2 = e7.onClick, Ge2 = e7.onMouseEnter, Ee = e7.onMouseMove, De2 = e7.onMouseLeave, Fe2 = e7.tooltip, He2 = void 0 === Fe2 ? Y3.tooltip : Fe2, Xe2 = e7.transitionMode, Ye2 = void 0 === Xe2 ? Y3.transitionMode : Xe2, je = e7.legends, Pe2 = void 0 === je ? Y3.legends : je, qe2 = e7.role, ze2 = void 0 === qe2 ? Y3.role : qe2, Je2 = Gt(G2, E5, D5), Ke2 = Je2.outerWidth, Ne2 = Je2.outerHeight, Qe2 = Je2.margin, Ue2 = Je2.innerWidth, Ze2 = Je2.innerHeight, $e3 = P3({ data: i4, id: a5, value: d3, valueFormat: l3, colors: H4 }), _e2 = J2({ data: $e3, width: Ue2, height: Ze2, fit: I2, innerRadius: M3, startAngle: b4, endAngle: k5, padAngle: O3, sortByValue: c9, cornerRadius: w4, activeInnerRadiusOffset: T4, activeOuterRadiusOffset: B5 }), ei = _e2.dataWithArc, ii = _e2.legendData, ni2 = _e2.arcGenerator, ti2 = _e2.centerX, ri2 = _e2.centerY, ai2 = _e2.radius, oi2 = _e2.innerRadius, di = _e2.setActiveId, li2 = _e2.toggleSerie, si2 = Ki(we2, ei, Se2), ci = { arcLinkLabels: null, arcs: null, arcLabels: null, legends: null };
  le && L2.includes("arcLinkLabels") && (ci.arcLinkLabels = (0, import_jsx_runtime5.jsx)(U, { center: [ti2, ri2], data: ei, label: ce, skipAngle: ve, offset: ge, diagonalLength: he, straightLength: pe, strokeWidth: Ae, textOffset: me, textColor: Ce2, linkColor: xe, component: Me2 }, "arcLinkLabels")), L2.includes("arcs") && (ci.arcs = (0, import_jsx_runtime5.jsx)(N3, { center: [ti2, ri2], data: ei, arcGenerator: ni2, borderWidth: q3, borderColor: Q3, isInteractive: Ve2, onClick: Be2, onMouseEnter: Ge2, onMouseMove: Ee, onMouseLeave: De2, setActiveId: di, tooltip: He2, transitionMode: Ye2 }, "arcs")), Z2 && L2.includes("arcLabels") && (ci.arcLabels = (0, import_jsx_runtime5.jsx)(B3, { center: [ti2, ri2], data: ei, label: _2, radiusOffset: ae, skipAngle: ie2, textColor: te, transitionMode: Ye2, component: oe }, "arcLabels")), Pe2.length > 0 && L2.includes("legends") && (ci.legends = (0, import_jsx_runtime5.jsx)(X3, { width: Ue2, height: Ze2, data: ii, legends: Pe2, toggleSerie: li2 }, "legends"));
  var ui = K4({ dataWithArc: ei, arcGenerator: ni2, centerX: ti2, centerY: ri2, radius: ai2, innerRadius: oi2 });
  return (0, import_jsx_runtime5.jsx)(wi, { width: Ke2, height: Ne2, margin: Qe2, defs: si2, role: ze2, children: L2.map(function(e8, i5) {
    return void 0 !== ci[e8] ? ci[e8] : "function" == typeof e8 ? (0, import_jsx_runtime5.jsx)(import_react20.Fragment, { children: (0, import_react20.createElement)(e8, ui) }, i5) : null;
  }) });
};
var Z = function(e7) {
  var i4 = e7.isInteractive, n4 = void 0 === i4 ? Y3.isInteractive : i4, t7 = e7.animate, r4 = void 0 === t7 ? Y3.animate : t7, a5 = e7.motionConfig, o4 = void 0 === a5 ? Y3.motionConfig : a5, d3 = e7.theme, l3 = e7.renderWrapper, s4 = F2(e7, Q2);
  return (0, import_jsx_runtime5.jsx)(Kt, { animate: r4, isInteractive: n4, motionConfig: o4, renderWrapper: l3, theme: d3, children: (0, import_jsx_runtime5.jsx)(U2, D4({ isInteractive: n4 }, s4)) });
};
var $ = function(e7) {
  return (0, import_jsx_runtime5.jsx)(Qt, { children: function(i4) {
    var n4 = i4.width, t7 = i4.height;
    return (0, import_jsx_runtime5.jsx)(Z, D4({ width: n4, height: t7 }, e7));
  } });
};
var _ = ["isInteractive", "theme", "renderWrapper"];
var ee = function(i4) {
  var n4 = i4.data, r4 = i4.id, d3 = void 0 === r4 ? Y3.id : r4, l3 = i4.value, s4 = void 0 === l3 ? Y3.value : l3, c9 = i4.valueFormat, u3 = i4.sortByValue, f3 = void 0 === u3 ? Y3.sortByValue : u3, g3 = i4.startAngle, L2 = void 0 === g3 ? Y3.startAngle : g3, p4 = i4.endAngle, k5 = void 0 === p4 ? Y3.endAngle : p4, A5 = i4.padAngle, R = void 0 === A5 ? Y3.padAngle : A5, m4 = i4.fit, y4 = void 0 === m4 ? Y3.fit : m4, S4 = i4.innerRadius, T4 = void 0 === S4 ? Y3.innerRadius : S4, V3 = i4.cornerRadius, G2 = void 0 === V3 ? Y3.cornerRadius : V3, F3 = i4.activeInnerRadiusOffset, H4 = void 0 === F3 ? Y3.activeInnerRadiusOffset : F3, X4 = i4.activeOuterRadiusOffset, j4 = void 0 === X4 ? Y3.activeOuterRadiusOffset : X4, q3 = i4.width, z5 = i4.height, K5 = i4.margin, N4 = i4.pixelRatio, Q3 = void 0 === N4 ? 1 : N4, U3 = i4.colors, Z2 = void 0 === U3 ? Y3.colors : U3, $2 = i4.borderWidth, _2 = void 0 === $2 ? Y3.borderWidth : $2, ee2 = i4.borderColor, ie2 = void 0 === ee2 ? Y3.borderColor : ee2, ne2 = i4.enableArcLabels, te = void 0 === ne2 ? Y3.enableArcLabels : ne2, re3 = i4.arcLabel, ae = void 0 === re3 ? Y3.arcLabel : re3, oe = i4.arcLabelsSkipAngle, de = void 0 === oe ? Y3.arcLabelsSkipAngle : oe, le = i4.arcLabelsTextColor, se = void 0 === le ? Y3.arcLabelsTextColor : le, ce = i4.arcLabelsRadiusOffset, ue = void 0 === ce ? Y3.arcLabelsRadiusOffset : ce, ve = i4.enableArcLinkLabels, fe = void 0 === ve ? Y3.enableArcLinkLabels : ve, ge = i4.arcLinkLabel, Le2 = void 0 === ge ? Y3.arcLinkLabel : ge, he = i4.arcLinkLabelsSkipAngle, be = void 0 === he ? Y3.arcLinkLabelsSkipAngle : he, pe = i4.arcLinkLabelsOffset, ke = void 0 === pe ? Y3.arcLinkLabelsOffset : pe, Ae = i4.arcLinkLabelsDiagonalLength, Re2 = void 0 === Ae ? Y3.arcLinkLabelsDiagonalLength : Ae, me = i4.arcLinkLabelsStraightLength, Oe2 = void 0 === me ? Y3.arcLinkLabelsStraightLength : me, Ce2 = i4.arcLinkLabelsThickness, Ie = void 0 === Ce2 ? Y3.arcLinkLabelsThickness : Ce2, xe = i4.arcLinkLabelsTextOffset, Me2 = void 0 === xe ? Y3.arcLinkLabelsTextOffset : xe, ye = i4.arcLinkLabelsTextColor, we2 = void 0 === ye ? Y3.arcLinkLabelsTextColor : ye, We2 = i4.arcLinkLabelsColor, Se2 = void 0 === We2 ? Y3.arcLinkLabelsColor : We2, Te2 = i4.isInteractive, Ve2 = void 0 === Te2 ? Y3.isInteractive : Te2, Be2 = i4.onClick, Ge2 = i4.onMouseMove, Ee = i4.tooltip, De2 = void 0 === Ee ? Y3.tooltip : Ee, Fe2 = i4.legends, He2 = void 0 === Fe2 ? Y3.legends : Fe2, Xe2 = (0, import_react20.useRef)(null), Ye2 = Ut(), je = Gt(q3, z5, K5), Pe2 = je.margin, qe2 = je.innerWidth, ze2 = je.innerHeight, Je2 = je.outerWidth, Ke2 = je.outerHeight, Ne2 = P3({ data: n4, id: d3, value: s4, valueFormat: c9, colors: Z2 }), Qe2 = J2({ data: Ne2, width: qe2, height: ze2, fit: y4, innerRadius: T4, startAngle: L2, endAngle: k5, padAngle: R, sortByValue: f3, cornerRadius: G2, activeInnerRadiusOffset: H4, activeOuterRadiusOffset: j4 }), Ue2 = Qe2.dataWithArc, Ze2 = Qe2.arcGenerator, $e3 = Qe2.centerX, _e2 = Qe2.centerY, ei = Qe2.radius, ii = Qe2.innerRadius, ni2 = Qe2.setActiveId, ti2 = We(ie2, Ye2), ri2 = z3({ data: Ue2, label: ae, skipAngle: de, offset: ue, textColor: se }), ai2 = Y({ data: Ue2, skipAngle: be, offset: ke, diagonalLength: Re2, straightLength: Oe2, label: Le2, linkColor: Se2, textOffset: Me2, textColor: we2 });
  (0, import_react20.useEffect)(function() {
    if (Xe2.current) {
      Xe2.current.width = Je2 * Q3, Xe2.current.height = Ke2 * Q3;
      var e7 = Xe2.current.getContext("2d");
      e7.scale(Q3, Q3), e7.fillStyle = Ye2.background, e7.fillRect(0, 0, Je2, Ke2), e7.save(), e7.translate(Pe2.left, Pe2.top), Ze2.context(e7), e7.save(), e7.translate($e3, _e2), Ue2.forEach(function(i5) {
        e7.beginPath(), e7.fillStyle = i5.color, e7.strokeStyle = ti2(i5), e7.lineWidth = _2, Ze2(i5.arc), e7.fill(), _2 > 0 && e7.stroke();
      }), true === fe && V2(e7, ai2, Ye2, Ie), true === te && w2(e7, ri2, Ye2), e7.restore(), He2.forEach(function(i5) {
        H2(e7, D4({}, i5, { data: Ue2, containerWidth: qe2, containerHeight: ze2, theme: Ye2 }));
      });
    }
  }, [Xe2, qe2, ze2, Je2, Ke2, Pe2.top, Pe2.left, Q3, $e3, _e2, Ze2, Ue2, ti2, te, ri2, fe, ai2, Ie, He2, Ye2]);
  var oi2 = (0, import_react20.useMemo)(function() {
    return Ue2.map(function(e7) {
      return D4({ id: e7.id }, e7.arc);
    });
  }, [Ue2]), di = function(e7) {
    if (!Xe2.current)
      return null;
    var i5 = Ei(Xe2.current, e7), n5 = i5[0], t7 = i5[1], r5 = ot(Pe2.left + $e3, Pe2.top + _e2, ei, ii, oi2, n5, t7);
    return r5 ? Ue2.find(function(e8) {
      return e8.id === r5.id;
    }) : null;
  }, li2 = k(), si2 = li2.showTooltipFromEvent, ci = li2.hideTooltip, ui = function(e7) {
    var i5 = di(e7);
    i5 ? (null == Ge2 || Ge2(i5, e7), ni2(i5.id), si2((0, import_react20.createElement)(De2, { datum: i5 }), e7)) : (ni2(null), ci());
  };
  return (0, import_jsx_runtime5.jsx)("canvas", { ref: Xe2, width: Je2 * Q3, height: Ke2 * Q3, style: { width: Je2, height: Ke2, cursor: Ve2 ? "auto" : "normal" }, onMouseEnter: Ve2 ? ui : void 0, onMouseMove: Ve2 ? ui : void 0, onMouseLeave: Ve2 ? function() {
    ci();
  } : void 0, onClick: Ve2 ? function(e7) {
    if (Be2) {
      var i5 = di(e7);
      i5 && Be2(i5, e7);
    }
...
var ie = function(e7) {
  var i4 = e7.isInteractive, n4 = void 0 === i4 ? Y3.isInteractive : i4, t7 = e7.theme, r4 = e7.renderWrapper, a5 = F2(e7, _);
  return (0, import_jsx_runtime5.jsx)(Kt, { isInteractive: n4, renderWrapper: r4, theme: t7, children: (0, import_jsx_runtime5.jsx)(ee, D4({ isInteractive: n4 }, a5)) });
};
var ne = function(e7) {
  return (0, import_jsx_runtime5.jsx)(Qt, { children: function(i4) {
    var n4 = i4.width, t7 = i4.height;
    return (0, import_jsx_runtime5.jsx)(ie, D4({ width: n4, height: t7 }, e7));
  } });
};
export {
  Z as Pie,
  ...
  Y3 as defaultProps,
  P3 as useNormalizedData,
  z4 as usePie,
  q2 as usePieArcs,
  J2 as usePieFromBox,
  K4 as usePieLayerContext
};
