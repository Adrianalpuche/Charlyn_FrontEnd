   ...
   <div className="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
      ...
      <div id="dropdown-cta" className="p-4 mt-6 rounded-lg bg-blue-50 dark:bg-blue-900" role="alert">
         ...
         <p className="mb-3 text-sm text-blue-800 dark:text-blue-400">
            Preview the new Charlyn dashboard navigation! You can turn the new navigation off for a limited time in your profile.
         </p>
         <a className="text-sm font-medium text-blue-800 underline hover:text-blue-900 dark:text-blue-400 dark:hover:text-blue-300" href="#">Turn new navigation off</a>
      </div>
   </div>
    </aside>
